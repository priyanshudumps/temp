...
const InsertOrUpdateCurrencyPricesData = async () => {
    try {
        ...
        const allSupportesCurrencies = await Clients.exchangeRateClient.getAllSupportedCodes();
        const allPricesUsd = await Clients.exchangeRateClient.getAllCurrenciesUsdPrices();
        ...
        await methods.currencyPrices.addMultipleCurrencyPricesOrUpdate(allCurrencyPrices);
